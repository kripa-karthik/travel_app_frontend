...
export const OrderSummaryComp = () => {
    ...
    return (
        <div className="order-summary-container d-flex direction-column shadow gap">
            ...
            <div>
                <button className="button btn-primary btn-reserve cursor" 
                    onClick={handleContinueBookingClick}>Continue Booking</button>
            </div>
        </div>
    )
}