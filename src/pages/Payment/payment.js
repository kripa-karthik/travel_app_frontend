...
export const Payment=()=>{
    ...
    const handleConfirmBookingClick=async()=>{
        ...
        const options={
            key:"enterrazorpaykey",
            amount:totalPayableAmount*100,
            currency:"INR",
            name:"TravelIn",
            email:"travelin@gmail.com",
            contact:"9876543216",
        ...
        <Fragment>
            <header className="heading">
                <h1 className="heading-1">
                    <Link className="link" to="/">TravelIn</Link>
                </h1>
            </header>
            <main className="payment-page d-flex justify-center">
                ...
                <div className="final-details d-flex direction-column gap-large">
                    ...
                    <div className="tag">
                        Your booking is protected by <strong className="strong">TravelIn</strong> cover
